...
public class TestAgente { // Esempio per motivare l'uso della reflection
    ...
    Usando la reflection si puo' scrivere un tester per l'homework senza avere
...
/*
Reflection possibili usi:
-fare un plugin, possiamo fare un tester anche se una parte del codice
